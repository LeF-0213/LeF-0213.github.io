...
Dictionary => 쌍(key: value)  
변수 = {키1:값1, 키2:값2 ...} => 키값은 중복 불가
```python
...
```python
student['전화번호'] = 01012345678
# SyntaxError: leading zeros in decimal integer literals are not permitted; use an 0o prefix for octal integers
student['전화번호'] = '01012345678'
student
# {'학번': 1, '이름': '홍길동', '학과': '마술학과', '전화번호': '01012345678'}
```
...
```python
student.values()
# dict_values([1, '홍길동', '미술학과', '01012345678'])
```
